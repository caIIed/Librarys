...
local library = {
    ...
    signal      = loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/Quenty/NevermoreEngine/main/src/signal/src/Shared/Signal.lua'))(),
    stat        = {fps = 0, ping = 0},
    drawings    = {
        active    = {},
        draggable = {},
