...
local library = {
    ...
    folders = {
        main = "Tokyohook.cc",
        assets = "Tokyohook.cc/assets",
        configs = "Tokyohook.cc/configs"
    },
    shared = {
        initialized = false,
        fps = 0,
	...
	uis.MouseIconEnabled = true
        ...
        function window:Watermark(info)
            ...
            local watermark_title = utility:Create("TextLabel", {Vector2.new(2 + 6,4), watermark_outline}, {
                Text = string.format("scrip - fps : %u - uid : %u", 35, 2),
                Size = theme.textsize,
                Font = theme.font,
                Color = theme.textcolor,
                OutlineColor = theme.textborder,
            ...
            utility:Connection(rs.RenderStepped, function(FPS)
                ...
                if (tick() - Tick) > 0.15 then
                    watermark_title.Text = string.format("Qw| Ping : %s | Fps : %u", library.shared.ping, library.shared.fps)
                    window.watermark:UpdateSize()
                    --
                    Tick = tick()
                end
